/* ProductDetail — me foto reale nese ka URL, ndryshe emoji */
...
export default function ProductDetail() {
  ...
  const hasImage = product.foto_kryesore && !imgError;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          ...
          <div className="bg-white rounded-2xl shadow-card overflow-hidden flex items-center justify-center min-h-[400px] relative">
            {hasImage ? (
              ...
              <div className="bg-bg w-full h-full flex items-center justify-center min-h-[400px]">
            ...
            <button
              ...
              className="absolute top-5 right-5 w-12 h-12 bg-white rounded-full flex items-center justify-center shadow border-0 cursor-pointer text-2xl"
            >
              {inWishlist ? "❤️" : "🤍"}
            </button>
          </div>
