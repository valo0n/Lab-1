...
/* Mapping per kategorit ne emoji - sepse DB nuk i ka */
...
export default function ProductCard({ product: p }) {
  ...
  /* Per CartContext - pershtate strukturen */
  const cartProduct = {
    id: p.id,
    name: p.emertimi,
    brand: p.marka,
